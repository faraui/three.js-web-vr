# three.js-web-vr
  ...
  Files `three.js` and `stats.js` were not written by me and are provided as given by their authors in certain versions from year 2022. All the other files are written by me.
